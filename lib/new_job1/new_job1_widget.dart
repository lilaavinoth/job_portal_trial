...
class NewJob1Widget extends StatefulWidget {
  ...
  final DocumentReference? isloaded;

  @override
  _NewJob1WidgetState createState() => _NewJob1WidgetState();
}
...
class _NewJob1WidgetState extends State<NewJob1Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'newJob1'});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'You haven\'t posted a job before, so you\'ll need to create and employer account.',
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'NEW_JOB1_SAVE_AND_CONTINUE_BTN_ON_TAP');
                                      ...
                                      //     .set({
                                      //   ...createCompanyDetailsRecordData(
                                      //     companyName:
                                      //         _model.textController1.text,
                                      //     noEmployees: _model.dropDownValue,
                                      //     name: _model.textController2.text,
                                      //     phoneNo: int.tryParse(
  ...
  Future uploadCompanyDetails() async {
    if (loggedIn) {
      Timestamp timestamp = Timestamp.now();
      final companyDetails = FirebaseFirestore.instance
          .collection('users')
          .doc(currentUserUid)
          .collection('companyDetails')
          .doc('companyData');

      final newdata = newCompanyModel(
          companyName: _model.textController1.text,
          noEmployees: _model.dropDownValue,
          name: _model.textController2.text,
          phoneNo: _model.textController3.text,
          created_date: timestamp);

      await companyDetails.set(newdata.toMap());
    }
  }
}
