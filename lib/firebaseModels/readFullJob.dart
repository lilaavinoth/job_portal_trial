...
class readFullJob {
  ...
  factory readFullJob.fromMap(Map<String, dynamic> map) {
    return readFullJob(
  ...
  factory readFullJob.fromJson(String source) => readFullJob.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  @override
  bool operator ==(covariant readFullJob other) {
